...
function HomePage() {
  return (
    <>
      <div className="bg-gradient-to-br from-base-100 via-base-200 mask-b-to-base-300">
        {/* NAVBAR */}
        <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
          <div className="max-w-7xl mx-auto px-4 p-4 flex items-center justify-between">
            {/* LOGO */}
            <Link
              to={"/"}
            ...
            <SignInButton mode="modal">
              <button
                className="group px-6 py-3 bg-gradient-to-r from-primary to-secondary rounded-xl text-white font-semibold text-sm shadow-lg hover:shadow-xl
                transition-all duration-200 hover:scale-105 flex itsms-center gap-2"
              >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body items-center text-center">
                <div className="size-16 bg-primary/10 rounded-2xl flex items-center mb-4 justify-center">
